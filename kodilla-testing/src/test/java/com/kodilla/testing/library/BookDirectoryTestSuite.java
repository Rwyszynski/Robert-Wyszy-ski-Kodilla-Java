...
class BookDirectoryTestSuite {
    ...
    @Test
    void testListBookWithFiveBooks() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOf5Books = generateListOfNBooks(5);
        LibraryUser libraryUser1 = new LibraryUser("Robert", "Gie", "maly");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1))
                .thenReturn(resultListOf5Books);

        // When
        List<Book> theListOfBooks5 = bookLibrary.listBooksInHandsOf(libraryUser1);
    ...
    void testListBookWithOneBooks() {
        ...
        // Then
        assertEquals(1, theListOfBooks5.size());
    }

    @Test
    void testListBookWithNoBooks() {
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        // Then
        assertEquals(0, theListOfBooks5.size());
    }
}